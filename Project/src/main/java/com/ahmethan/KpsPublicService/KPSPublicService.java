package com.ahmethan.KpsPublicService;
...
public class KPSPublicService {
    public boolean validate(String tckno, String firstName, String lastName, int dateOfBirth){
        try{

            HttpURLConnection connection = createSoapConnection("https://tckimlik.nvi.gov.tr/Service/KPSPublic.asmx");
            String response = postRequest(connection, createKPSSoapRequest(tckno, firstName,lastName,dateOfBirth));
    ...
    private String createKPSSoapRequest(String tckno, String firstName, String lastName, int dateOfBirth){
        return String.format(
                "<?xml version=\"1.0\" encoding=\"utf-8\"?>"
                        ...
                        + "</soap12:Body>"
                        + "</soap12:Envelope>",
                tckno, firstName, lastName, dateOfBirth);
    }
